...
export default async function Page({
  ...
  const code = typeof searchParamsObj.code === 'string' ? searchParamsObj.code : undefined;
  const access_token = typeof searchParamsObj.access_token === 'string' ? searchParamsObj.access_token : undefined;
  const refresh_token = typeof searchParamsObj.refresh_token === 'string' ? searchParamsObj.refresh_token : undefined;
